...
public class AdCarouselDBGifReaderController {
...
//	public void dBGifReader(@RequestParam("adcId") String adcId, HttpServletRequest req, HttpServletResponse res)
//			                                                                                          throws IOException {
...
//		@GetMapping("/DBGifReader/{adcId}")
//	    public ResponseEntity<byte[]> getAdCarouselImage(@PathVariable Integer adcId) {
//	    	AdCarouselVO adCarouselVO = AdCarSvc.getOneAdcId(adcId);
//	    	String path = "src/main/resources/static/assets/images/client/joinus.jpg";
//	    	Path filePath = Paths.get(path);
//	    	byte [] defaultphoto = null;
//	    	try {
//	    		defaultphoto = Files.readAllBytes(filePath);
//	    	} catch (IOException e) {
//	    		e.printStackTrace();
//	    	}
//	    	if ( adCarouselVO.getAdcUpdatePic() != null) {
//	    		HttpHeaders headers = new HttpHeaders();
//	    		headers.setContentType(MediaType.IMAGE_JPEG);
//	    		return new ResponseEntity<>(adCarouselVO.getAdcUpdatePic(), headers, HttpStatus.OK);
//	    	} else {
//	    		HttpHeaders headers = new HttpHeaders();
//	    		headers.setContentType(MediaType.IMAGE_JPEG);
//	    		return new ResponseEntity<>(defaultphoto, headers, HttpStatus.OK);
//	    	}
//	    }
...
//		try {
//
//			out.write(AdCarSvc.getOneAdcId(Integer.valueOf(adcId)).getAdcUpdatePic());
//		} catch (Exception e) {
