...
//      請在這邊設定需要過濾登入狀態的網址
		...
		// "/cart/*",
		registrationBean.addUrlPatterns("/opinion/user_opinion_list/*", "/user_create_opinion/*", "/cart/check/*",
				"/opinion_api/user_create_opinion", "/socialpost/*", "/order/*",  "/course/my_courses/*","/adCarousel/addAdCarousel/*",
